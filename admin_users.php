    ...
    <table class="table table-striped table-bordered table-condensed">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="edit_admin.php?admin_user_id=<?php echo $row['id']; ?>&operation=edit" class="btn btn-primary" title="Click here to Edit"><i class="glyphicon glyphicon-edit"></i></a>
                    <a href="#" class="btn btn-danger delete_btn" data-toggle="modal" data-target="#confirm-delete-<?php echo $row['id']; ?>" title="Click here to Delete this user"><i class="glyphicon glyphicon-trash"></i></a>
                    <a href="user_privillage.php?admin_user_id=<?php echo $row['id']; ?>" class="btn btn-primary otp_btn" title="Change User Privilege"><i class="fa fa-key" ></i></a>
                    <a href="assign_tasks.php?admin_user_id=<?php echo $row['id']; ?>" class="btn btn-success otp_btn" title="Click here to assing Taks for this User"><i class="fa fa-tasks"></i></a>
                </td>
            </tr>
