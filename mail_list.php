...
$db = getDbInstance();
$select = array('id', 'username', 'from_name', 'smtp_host', 'smtp_port');
...
$rows = $db->arraybuilder()->paginate('email_details', $page, $select);
    ...
    <table class="table table-striped table-bordered table-condensed">
        <thead>
            <tr>
                ...
                <th width="20%">SMTPHost</th>
                <th width="10%">SMTPPort</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo htmlspecialchars($row['smtp_host']);?></td>
                <td><?php echo htmlspecialchars($row['smtp_port']);?></td>
                <td>
